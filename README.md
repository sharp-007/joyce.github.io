...
个人作品集展示站点，基于纯前端技术栈（HTML + CSS + JavaScript）构建，集成 Sveltia CMS 可视化内容管理系统。用于展示个人项目、公开演讲、博客文章、工作经历等内容，支持中英文双语切换。
...
- [3. 快速开始](#3-快速开始)
- [4. 内容管理系统](#4-内容管理系统)
  - [4.1 为什么选择可视化 CMS](#41-为什么选择可视化-cms)
  - [4.2 支持管理的内容模块](#42-支持管理的内容模块)
  - [4.3 在线使用](#43-在线使用)
  - [4.4 CMS 操作演示](#44-cms-操作演示)
  - [4.5 本地开发使用](#45-本地开发使用)
  - [4.6 GitHub OAuth 配置](#46-github-oauth-配置)
  - [4.7 图片管理](#47-图片管理)
- [5. 部署指南](#5-部署指南)
  - [5.1 GitHub Pages 部署](#51-github-pages-部署)
  - [5.2 自定义域名](#52-自定义域名)
  - [5.3 本地预览](#53-本地预览)
- [6. 项目结构](#6-项目结构)
- [7. 自定义修改](#7-自定义修改)
...
| 🎤 公开演讲 | 技术分享、演讲、会议 | 类型、标题、封面、链接、日期、标签 |
...
<table>
  <tr>
    <td><img src="images/uploads/CMS-1.png" alt="CMS Collections View"></td>
    <td><img src="images/uploads/CMS-2.png" alt="CMS Edit View"></td>
  </tr>
  <tr>
    <td align="center"><b>内容集合列表</b></td>
    <td align="center"><b>可视化编辑界面</b></td>
  </tr>
</table>
